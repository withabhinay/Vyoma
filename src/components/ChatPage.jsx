...
export const ChatPage = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      setIsLoading(true);
      try {
        const res = await fetch("https://adi-project.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-08-01-preview ", { // Replace with your API endpoint
          method: "POST",
          headers: {
